...
let rootUrl = URL(string: "https://ais-pre-cdvalub3mntrwuiqxsmksn-717516493986.europe-west2.run.app")!

// allowed origin is for what we are sticking to pwa domain
// This should also appear in Info.plist
let allowedOrigins: [String] = ["ais-pre-cdvalub3mntrwuiqxsmksn-717516493986.europe-west2.run.app"]
